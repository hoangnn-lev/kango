function Controller() {
    ...
    $.__views.scheduleTitle.add($.__views.__alloyId37);
    addEvent ? $.__views.__alloyId37.addEventListener("click", addEvent) : __defers["$.__views.__alloyId37!click!addEvent"] = true;
    ...
    $.__views.blockFriend.add($.__views.__alloyId38);
    ...
    $.__views.__alloyId38.add($.__views.openAllFriend);
    ...
    $.__views.__alloyId38.add($.__views.serviceMember);
    ...
    $.__views.blockFriend.add($.__views.__alloyId40);
    ...
    __defers["$.__views.__alloyId37!click!addEvent"] && $.__views.__alloyId37.addEventListener("click", addEvent);
