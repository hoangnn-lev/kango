function Controller() {
    ...
    $.__views.title.add($.__views.__alloyId81);
    ...
    $.__views.__alloyId82.add($.__views.shiftName);
    ...
    $.__views.__alloyId82.add($.__views.shiftAlias);
    ...
    $.__views.__alloyId84.add($.__views.timeStart);
    ...
    $.__views.__alloyId85.add($.__views.timeEnd);
    ...
    $.__views.groupButton.add($.__views.__alloyId87);
    shift_setting ? $.__views.__alloyId87.addEventListener("click", shift_setting) : __defers["$.__views.__alloyId87!click!shift_setting"] = true;
    ...
    __defers["$.__views.__alloyId87!click!shift_setting"] && $.__views.__alloyId87.addEventListener("click", shift_setting);
    _.extend($, exports);
}
