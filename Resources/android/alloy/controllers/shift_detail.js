function Controller() {
    ...
    $.__views.__alloyId65.add($.__views.shiftName);
    ...
    $.__views.__alloyId65.add($.__views.shiftAlias);
    ...
    timeSet ? $.__views.__alloyId67.addEventListener("click", timeSet) : __defers["$.__views.__alloyId67!click!timeSet"] = true;
    ...
    $.__views.__alloyId67.add($.__views.startTime);
    ...
    $.__views.__alloyId67.add($.__views.clearStartTime);
    ...
    timeSet ? $.__views.__alloyId69.addEventListener("click", timeSet) : __defers["$.__views.__alloyId69!click!timeSet"] = true;
    ...
    $.__views.__alloyId69.add($.__views.endTime);
    ...
    $.__views.__alloyId69.add($.__views.clearEndTime);
    ...
    $.__views.groupButton.add($.__views.__alloyId71);
    shift_setting ? $.__views.__alloyId71.addEventListener("click", shift_setting) : __defers["$.__views.__alloyId71!click!shift_setting"] = true;
    ...
    __defers["$.__views.__alloyId67!click!timeSet"] && $.__views.__alloyId67.addEventListener("click", timeSet);
    __defers["$.__views.clearStartTime!click!clearTime"] && $.__views.clearStartTime.addEventListener("click", clearTime);
    __defers["$.__views.__alloyId69!click!timeSet"] && $.__views.__alloyId69.addEventListener("click", timeSet);
    __defers["$.__views.clearEndTime!click!clearTime"] && $.__views.clearEndTime.addEventListener("click", clearTime);
    __defers["$.__views.__alloyId71!click!shift_setting"] && $.__views.__alloyId71.addEventListener("click", shift_setting);
    _.extend($, exports);
}
