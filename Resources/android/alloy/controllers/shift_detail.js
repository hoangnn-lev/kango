function Controller() {
    ...
    $.__views.title.add($.__views.__alloyId68);
    ...
    $.__views.__alloyId69.add($.__views.content);
    ...
    $.__views.__alloyId70.add($.__views.shiftName);
    ...
    $.__views.__alloyId70.add($.__views.shiftAlias);
    ...
    timeSet ? $.__views.__alloyId72.addEventListener("click", timeSet) : __defers["$.__views.__alloyId72!click!timeSet"] = true;
    ...
    $.__views.__alloyId72.add($.__views.startTime);
    ...
    $.__views.__alloyId72.add($.__views.clearStartTime);
    ...
    timeSet ? $.__views.__alloyId74.addEventListener("click", timeSet) : __defers["$.__views.__alloyId74!click!timeSet"] = true;
    ...
    $.__views.__alloyId74.add($.__views.endTime);
    ...
    $.__views.__alloyId74.add($.__views.clearEndTime);
    ...
    $.__views.groupButton.add($.__views.__alloyId76);
    shift_setting ? $.__views.__alloyId76.addEventListener("click", shift_setting) : __defers["$.__views.__alloyId76!click!shift_setting"] = true;
    ...
    __defers["$.__views.__alloyId72!click!timeSet"] && $.__views.__alloyId72.addEventListener("click", timeSet);
    __defers["$.__views.clearStartTime!click!clearTime"] && $.__views.clearStartTime.addEventListener("click", clearTime);
    __defers["$.__views.__alloyId74!click!timeSet"] && $.__views.__alloyId74.addEventListener("click", timeSet);
    __defers["$.__views.clearEndTime!click!clearTime"] && $.__views.clearEndTime.addEventListener("click", clearTime);
    __defers["$.__views.__alloyId76!click!shift_setting"] && $.__views.__alloyId76.addEventListener("click", shift_setting);
    _.extend($, exports);
}
