function Controller() {
    ...
    $.__views.main.add($.__views.titleEvent);
    ...
    $.__views.titleEvent.add($.__views.__alloyId2);
    ...
    $.__views.__alloyId4.add($.__views.dayName);
    ...
    $.__views.__alloyId5.add($.__views.startTime);
    ...
    $.__views.__alloyId5.add($.__views.clearStartTime);
    ...
    timeSet ? $.__views.__alloyId7.addEventListener("click", timeSet) : __defers["$.__views.__alloyId7!click!timeSet"] = true;
    ...
    $.__views.__alloyId7.add($.__views.endTime);
    ...
    $.__views.__alloyId7.add($.__views.clearEndTime);
    ...
    $.__views.groupButton.add($.__views.__alloyId9);
    saveSchedule ? $.__views.__alloyId9.addEventListener("click", saveSchedule) : __defers["$.__views.__alloyId9!click!saveSchedule"] = true;
    ...
    __defers["$.__views.__alloyId9!click!saveSchedule"] && $.__views.__alloyId9.addEventListener("click", saveSchedule);
    _.extend($, exports);
}
