function Controller() {
    ...
    showPicker ? $.__views.__alloyId48.addEventListener("click", showPicker) : __defers["$.__views.__alloyId48!click!showPicker"] = true;
    ...
    $.__views.__alloyId48.add($.__views.month);
    ...
    share ? $.__views.__alloyId49.addEventListener("click", share) : __defers["$.__views.__alloyId49!click!share"] = true;
    ...
    $.__views.groupButton.add($.__views.__alloyId50);
    ...
    __defers["$.__views.__alloyId48!click!showPicker"] && $.__views.__alloyId48.addEventListener("click", showPicker);
    __defers["$.__views.__alloyId49!click!share"] && $.__views.__alloyId49.addEventListener("click", share);
    __defers["$.__views.__alloyId50!click!share"] && $.__views.__alloyId50.addEventListener("click", share);
    _.extend($, exports);
}
