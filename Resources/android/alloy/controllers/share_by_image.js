function Controller() {
    ...
    $.__views.title.add($.__views.__alloyId52);
    ...
    showPicker ? $.__views.__alloyId54.addEventListener("click", showPicker) : __defers["$.__views.__alloyId54!click!showPicker"] = true;
    ...
    $.__views.__alloyId54.add($.__views.month);
    ...
    share ? $.__views.__alloyId55.addEventListener("click", share) : __defers["$.__views.__alloyId55!click!share"] = true;
    ...
    share ? $.__views.__alloyId56.addEventListener("click", share) : __defers["$.__views.__alloyId56!click!share"] = true;
    ...
    __defers["$.__views.__alloyId54!click!showPicker"] && $.__views.__alloyId54.addEventListener("click", showPicker);
    __defers["$.__views.__alloyId55!click!share"] && $.__views.__alloyId55.addEventListener("click", share);
    __defers["$.__views.__alloyId56!click!share"] && $.__views.__alloyId56.addEventListener("click", share);
    _.extend($, exports);
}
