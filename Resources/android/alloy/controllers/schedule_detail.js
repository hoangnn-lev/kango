function Controller() {
    ...
    $.__views.top.add($.__views.__alloyId44);
    ...
    cancelEditSchulde ? $.__views.__alloyId45.addEventListener("click", cancelEditSchulde) : __defers["$.__views.__alloyId45!click!cancelEditSchulde"] = true;
    ...
    $.__views.__alloyId44.add($.__views.dateTitle);
    ...
    saveSchedule ? $.__views.__alloyId48.addEventListener("click", saveSchedule) : __defers["$.__views.__alloyId48!click!saveSchedule"] = true;
    ...
    $.__views.friendBlock.add($.__views.__alloyId49);
    ...
    $.__views.friendBlock.add($.__views.__alloyId50);
    ...
    $.__views.groupButton.add($.__views.__alloyId58);
    ...
    $.__views.groupButton.add($.__views.__alloyId59);
    ...
    loadFriend();
    __defers["$.__views.__alloyId45!click!cancelEditSchulde"] && $.__views.__alloyId45.addEventListener("click", cancelEditSchulde);
    __defers["$.__views.__alloyId48!click!saveSchedule"] && $.__views.__alloyId48.addEventListener("click", saveSchedule);
    _.extend($, exports);
}
