function Controller() {
    ...
    shift_setting ? $.__views.__alloyId65.addEventListener("click", shift_setting) : __defers["$.__views.__alloyId65!click!shift_setting"] = true;
    ...
    edit_members ? $.__views.__alloyId69.addEventListener("click", edit_members) : __defers["$.__views.__alloyId69!click!edit_members"] = true;
    ...
    $.__views.__alloyId64.add($.__views.__alloyId72);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId73);
    ...
    $.__views.__alloyId73.add($.__views.showMember);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId75);
    ...
    $.__views.__alloyId76.add($.__views.monday_set);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId78);
    ...
    $.__views.__alloyId78.add($.__views.allHospital);
    ...
    $.__views.allHospital.add($.__views.__alloyId80);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId81);
    guideUseCalendar ? $.__views.__alloyId81.addEventListener("click", guideUseCalendar) : __defers["$.__views.__alloyId81!click!guideUseCalendar"] = true;
    ...
    $.__views.__alloyId64.add($.__views.__alloyId84);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId85);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId88);
    ...
    $.__views.__alloyId64.add($.__views.report);
    ...
    $.__views.report.add($.__views.__alloyId90);
    ...
    $.__views.__alloyId64.add($.__views.__alloyId91);
    ...
    $.__views.__alloyId64.add($.__views.about);
    ...
    $.__views.about.add($.__views.__alloyId93);
    ...
    __defers["$.__views.__alloyId65!click!shift_setting"] && $.__views.__alloyId65.addEventListener("click", shift_setting);
    __defers["$.__views.__alloyId69!click!edit_members"] && $.__views.__alloyId69.addEventListener("click", edit_members);
    ...
    __defers["$.__views.__alloyId81!click!guideUseCalendar"] && $.__views.__alloyId81.addEventListener("click", guideUseCalendar);
    _.extend($, exports);
}
