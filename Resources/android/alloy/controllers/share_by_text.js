function Controller() {
    ...
    $.__views.title.add($.__views.__alloyId51);
    ...
    $.__views.__alloyId54.add($.__views.dayStart);
    ...
    $.__views.__alloyId56.add($.__views.dayEnd);
    ...
    share ? $.__views.__alloyId58.addEventListener("click", share) : __defers["$.__views.__alloyId58!click!share"] = true;
    ...
    __defers["$.__views.__alloyId58!click!share"] && $.__views.__alloyId58.addEventListener("click", share);
