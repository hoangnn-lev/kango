function Controller() {
    ...
    $.__views.title.add($.__views.__alloyId100);
    ...
    $.__views.__alloyId103.add($.__views.dayStart);
    ...
    $.__views.__alloyId105.add($.__views.dayEnd);
    ...
    $.__views.groupButton.add($.__views.__alloyId108);
    share ? $.__views.__alloyId108.addEventListener("click", share) : __defers["$.__views.__alloyId108!click!share"] = true;
    ...
    __defers["$.__views.__alloyId108!click!share"] && $.__views.__alloyId108.addEventListener("click", share);
    _.extend($, exports);
}
