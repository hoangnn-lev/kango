function Controller() {
    ...
    $.__views.shift.add($.__views.__alloyId86);
    ...
    $.__views.__alloyId87.add($.__views.prevMonth);
    ...
    $.__views.__alloyId87.add($.__views.currentDate);
    ...
    $.__views.__alloyId87.add($.__views.nextMonth);
    ...
    $.__views.shift.add($.__views.__alloyId88);
    ...
    $.__views.__alloyId89.add($.__views.days);
    $.__views.calendar = Ti.UI.createView({
        id: "calendar",
        height: Ti.UI.SIZE
    });
    $.__views.__alloyId89.add($.__views.calendar);
    ...
    $.__views.__alloyId88.add($.__views.scheduleInfo);
    ...
    $.__views.scheduleInfo.add($.__views.__alloyId91);
    ...
    $.__views.__alloyId91.add($.__views.scheduleDateInfo);
    ...
    $.__views.__alloyId88.add($.__views.shiftList);
    ...
    shiftSetting ? $.__views.__alloyId92.addEventListener("click", shiftSetting) : __defers["$.__views.__alloyId92!click!shiftSetting"] = true;
    ...
    __defers["$.__views.__alloyId92!click!shiftSetting"] && $.__views.__alloyId92.addEventListener("click", shiftSetting);
    _.extend($, exports);
}
