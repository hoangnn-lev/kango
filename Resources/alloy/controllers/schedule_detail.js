function Controller() {
    ...
    $.__views.top.add($.__views.__alloyId33);
    ...
    cancelEditSchulde ? $.__views.__alloyId34.addEventListener("click", cancelEditSchulde) : __defers["$.__views.__alloyId34!click!cancelEditSchulde"] = true;
    ...
    $.__views.__alloyId33.add($.__views.dateTitle);
    ...
    saveSchedule ? $.__views.__alloyId37.addEventListener("click", saveSchedule) : __defers["$.__views.__alloyId37!click!saveSchedule"] = true;
    ...
    $.__views.friendBlock.add($.__views.__alloyId38);
    ...
    $.__views.friendBlock.add($.__views.__alloyId39);
    ...
    $.__views.content.add($.__views.__alloyId41);
    ...
    $.__views.groupButton.add($.__views.__alloyId47);
    ...
    $.__views.groupButton.add($.__views.__alloyId48);
    ...
    $.__views.groupButton.add($.__views.__alloyId49);
    ...
    loadFriend();
    __defers["$.__views.__alloyId34!click!cancelEditSchulde"] && $.__views.__alloyId34.addEventListener("click", cancelEditSchulde);
    __defers["$.__views.__alloyId37!click!saveSchedule"] && $.__views.__alloyId37.addEventListener("click", saveSchedule);
    _.extend($, exports);
}
