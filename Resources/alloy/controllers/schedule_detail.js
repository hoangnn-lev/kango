function Controller() {
    ...
    $.__views.top.add($.__views.__alloyId34);
    ...
    cancelEditSchulde ? $.__views.__alloyId35.addEventListener("click", cancelEditSchulde) : __defers["$.__views.__alloyId35!click!cancelEditSchulde"] = true;
    ...
    $.__views.__alloyId34.add($.__views.dateTitle);
    ...
    $.__views.friendBlock.add($.__views.__alloyId40);
    ...
    loadFriend();
    __defers["$.__views.__alloyId35!click!cancelEditSchulde"] && $.__views.__alloyId35.addEventListener("click", cancelEditSchulde);
