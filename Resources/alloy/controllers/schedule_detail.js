function Controller() {
    ...
    $.__views.__alloyId35.add($.__views.dateTitle);
    ...
    saveSchedule ? $.__views.__alloyId39.addEventListener("click", saveSchedule) : __defers["$.__views.__alloyId39!click!saveSchedule"] = true;
    ...
    $.__views.friendBlock.add($.__views.__alloyId41);
    ...
    $.__views.groupButton.add($.__views.__alloyId51);
    ...
    __defers["$.__views.__alloyId39!click!saveSchedule"] && $.__views.__alloyId39.addEventListener("click", saveSchedule);
    _.extend($, exports);
}
