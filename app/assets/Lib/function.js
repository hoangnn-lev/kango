...
exports.createBoxIcon = function(button, viewIcon, selectedIcon) {
	...
	for (var i = 0; i < l; i++) {
		...
		if ((i == 0 && selectedIcon == '' && buttonTabs[0]['icons'] != '') || (i == 1 && selectedIcon == '' && buttonTabs[0]['icons'] == '')) {
...
exports.globalSelectedDate = function(date, view) {
	...
	if (Ti.API.GLOBAL_SELECTED && Ti.API.GLOBAL_SELECTED != date)
		delete_view(view);

	if (date)
		Ti.API.GLOBAL_SELECTED = date;
